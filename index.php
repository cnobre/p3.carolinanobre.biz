    ...
    <body>
        <div class="container theme-showcase">
                ...
                <div class="jumbotron">
                  ...
                  which will use php and a mysql database to access the cruise database information. </p>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="panel panel-default">
                        ...
                        <option value='1'>Bob Pickart</option>
                        <option value='2'>Carin Ashten</option>
                        <option value='3'>Bob Day</option>
                    </select>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <select class="selectpicker" data-live-search="true" >
                        <option value='0'></option>   
                        <option value='1'>Healy</option>
                        <option value='2'>Knorr</option>
                        <option value='3'>JCR</option>
                    </select>
